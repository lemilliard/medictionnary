						...
						echo 'user is login : '. $is_login .' $$$$'; ?>
						  <div class="mx-3">
						    <div class="md-form mb-5">
							  ...
							  <label data-error="wrong" data-success="right" for="socialSecurityNumber">Numéro sécurité sociale</label>
							</div>
							<div class="md-form mb-5">
							...
							<div class="md-form mb-5">
							  ...
							  <label data-error="wrong" data-success="right" for="weight">Poids</label>
							</div>
