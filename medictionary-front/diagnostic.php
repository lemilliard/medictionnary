...
<body>
      ...
      <nav class="navbar fixed-top navbar-expand-lg navbar-dark scrolling-navbar">
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
			...
			<?php $is_login = false; if($is_login){ ?>
					<a class="nav-link" href="/edit-user">Mon compte</a> 
					<button type="button" class="btn  btn-outline-white waves-effect" data-toggle="modal" data-target="#modalLoginForm">Se connecter</button>
					<button type="button" class="btn  btn-outline-white waves-effect" data-toggle="modal" data-target="#modalRegisterForm">S'enregistrer</button>
				<?php }else{ ?>
					...
					<button type="button" class="btn  btn-white btn-rounded waves-effect" data-toggle="modal" data-target="#modalLoginForm">Se connecter</button>
					<button type="button" class="btn  btn-warning btn-rounded waves-effect" data-toggle="modal" data-target="#modalRegisterForm">S'enregistrer</button>
  ...
  <script type="text/javascript" src="../js/user/register-user.js"></script>
  <script type="text/javascript" src="../js/user/login-user.js"></script>
  <script type="text/javascript" src="js/getSymptoms.js"></script>
  <!-- Initializations -->
