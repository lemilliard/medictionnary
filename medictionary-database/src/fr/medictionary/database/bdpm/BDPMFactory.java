package fr.medictionary.database.bdpm;

import fr.medictionary.database.bdpm.config.Config;
import fr.medictionary.database.bdpm.config.Key;
import fr.medictionary.database.bdpm.config.Retriever;
import fr.medictionary.database.bdpm.object.*;
import fr.medictionary.database.mapper.Mapper;
